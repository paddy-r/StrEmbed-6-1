...
# paper_dir = <PATH> # MUST ADD
# file1 = os.path.join(paper_dir, 'T0.STEP')
# file2 = os.path.join(paper_dir, 'T0_French.STEP')
...
'''HR 22/06/22 Results for BoM recon paper '''

#bom_dir = <PATH> # MUST ADD
file1 = os.path.join(paper_dir, file1)
file2 = os.path.join(paper_dir, file2)
...
# # ass2.remove_redundants()
# am.AddToLattice(id3, stages = [(('bb', {}), ('mb', {'weights': [1,0,1,0]}))])


# save_file = "ass1.asy"

# am.save_assembly(save_file,id1)

# id2,ass2 = am.import_assembly(save_file)

# id2, ass2 = am.duplicate_assembly(id1)
# id2, ass2 = am.new_assembly(id_to_duplicate = id1)
# ass2.load_step(file2)
# am.AddToLattice(id2)

# id2, ass2 = am.import_assembly("assembly_20220412-153116.asy")

# n1 = 8
# n2 = n1

# shape1 = ass1.nodes[n1]['shape_loc'][0]
# shape2 = ass2.nodes[n2]['shape_loc'][0]

# res1 = sp.get_dimensions(shape1)
# res2 = sp.get_dimensions(shape2)
